                    ...
                    <div className="alinha">
                        ...
                        {/* <!--TEMAS SELECIONADOS--> */}
                                ...
                                <div className="form-group">
                                    <label htmlFor="fupload" className="control-label label-bordered" id="anexar"> Enviar Arquivos</label>
            ...
            <div className="post">
                ...
                <div>
                    <div className="alinha">
                        ...
                        {/*Temas Escolhidos*/}
                        <div id="TemaP">
                            <span className="badge badge-primary">Superação</span>
                            <span className="badge badge-primary">Ansiedade</span>
                            <span className="badge badge-primary">Relatos</span>
                        </div>
                    </div>

                    {/*Interações - like*/}
                    <div className="botoes">
                        <button className="buttonL" onClick={() => { adicionarLike() }}>
                        <img src={like} alt="likes"/>
                        {qtdLike}</button>
                        <button className="buttonL"><img src={comment} alt="comment" id="comment"/></button>
                        <button className="buttonL"><img src={share} alt="share"/></button>
                    </div>
                </div>
            </div>
        <footer>
